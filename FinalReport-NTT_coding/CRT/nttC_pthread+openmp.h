...
// // 定义多模数NTT所需的小模数集合
// const __int128 MOD1 = 998244353;
// const __int128 MOD2 = 754974721;
// const __int128 MOD3 = 167772161;
// const __int128 MOD4 = 469762049;
// const __int128 MOD5 = 1004535809;
...
//     const std::vector<__int128>* moduli;
//     int* final_result;
//     __int128 p;
//     int start_idx;
//     int end_idx;
...
//                              __int128 mod, int primitive_root, int* ta, int* tb) {
//     int len = 1;
//     while (len < 2 * n) len <<= 1;
...
//                             params->n, params->mod, 
//                             params->primitive_root, params->ta, params->tb);
//     return nullptr;
// }
...
//     const std::vector<__int128>& moduli = *(params->moduli);
...
//         results[i] = new int[2 * MAXN];
//         params[i] = {a, b, results[i], n, moduli[i], primitive_roots[i], 
//                      ta_buffers[i].data(), tb_buffers[i].data()};
